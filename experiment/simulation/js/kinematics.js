...
function CreateGeometries(){
	...
	SimulatorSetup.Joint23=new Joint(SimulatorSetup.glink2,SimulatorSetup.glink3,l3, a3, z3, 0*Math.PI/2, 10,slidertube);
	SimulatorSetup.Joint35=new Joint(SimulatorSetup.glink3,SimulatorSetup.glink5,l5, a5, z5, 0*Math.PI/2, 10,0);
	SimulatorSetup.Joint34=new Joint(SimulatorSetup.glink3,SimulatorSetup.glink4,l4, a4, z4, 0*Math.PI/2, 10);
	...
	SimulatorSetup.Joint35.CreateJoint();
...
function RemoveGeometries(){
    ...
    SimulatorSetup.glink3.remove(SimulatorSetup.glink5);
...
function CrankRotator12(sliderVal) {
	...
	th1=0.0;
	th12=sliderVal*Math.PI/180;
	th2=th12;

	d=l4*l4-(l1*Math.cos(th2)-(l2-l3))*(l1*Math.cos(th2)-(l2-l3));
	if (d>0) {
		s23=l1*Math.sin(th2)+toggle*Math.sqrt(d);
		th4=Math.atan2(-s23*Math.cos(th2)+(l2-l3)*Math.sin(th2), -l1+s23*Math.sin(th2)+(l2-l3)*Math.cos(th2));
		th3=th2+Math.PI;
		th12=th2-th1;
		th23=th3-th12;
		th41=th1-th4;
		...
		SimulatorSetup.Joint23.MoveJoint(s23,th23*1);
		SimulatorSetup.Joint34.MoveJoint(0,th34*1);
		SimulatorSetup.Joint35.MoveJoint(0,th35*1);
		...
		if (document.getElementById("th12x").checked==true ) {
			...
			if (document.getElementById("s23y").checked==true ) {		
				ctx.beginPath();
				ctx.arc(Math.round((th12*180/Math.PI)*c2d.width/720), -Math.round((s23*360/(l1+l4+l2-l3))*c2d.height/720), 2, 0, 2 * Math.PI, false);
		...
		if (document.getElementById("s23x").checked==true ) {
			if (document.getElementById("th12y").checked==true ) {		
				ctx.beginPath();
				ctx.arc(Math.round((s23*360/(l1+l4+l2-l3))*c2d.width/720), -Math.round((th12*180/Math.PI)*c2d.height/720), 2, 0, 2 * Math.PI, false);
				ctx.fillStyle = "rgb(127, 128, 0)";
				ctx.fill();
			}
			if (document.getElementById("s23y").checked==true ) {		
				ctx.beginPath();
				ctx.arc(Math.round((s23*360/(l1+l4+l2-l3))*c2d.width/720), -Math.round((s23*360/(l1+l4+l2-l3))*c2d.height/720), 2, 0, 2 * Math.PI, false);
				ctx.fillStyle = "rgb(0, 127, 128)";
				ctx.fill();
			}
			if (document.getElementById("th41y").checked==true ) {		
				ctx.beginPath();
				ctx.arc(Math.round((s23*360/(l1+l4+l2-l3))*c2d.width/720), -Math.round((th41*180/Math.PI)*c2d.height/720), 2, 0, 2 * Math.PI, false);
		...
		if (document.getElementById("th41x").checked==true ) {
			...
			if (document.getElementById("s23y").checked==true ) {		
				ctx.beginPath();
				ctx.arc(Math.round((th41*180/Math.PI)*c2d.height/720), -Math.round((s23*360/(l1+l4+l2-l3))*c2d.height/720), 2, 0, 2 * Math.PI, false);
...
function CrankRotator41(sliderVal) {
	...
	d=l1*l1+l4*l4-(l2-l3)*(l2-l3)+2*l1*l4*Math.cos(th4);
	if (d>0) {
		s23=toggle*Math.sqrt(d);
		a=(l2-l3)*l4*Math.sin(th4)+s23*l4*Math.cos(th4)+s23*l1;
		b=(l2-l3)*l4*Math.cos(th4)-s23*l4*Math.sin(th4)+(l2-l3)*l1;
		th2=Math.atan2(a,b);
		th3=th2+Math.PI;
		th12=th2-th1;
		th23=th3-th12;
...
function CrankRotator23(sliderVal) {
	...
	a=2.0*l1*(l2-l3);
	b=2.0*l1*s23;
	c=-l1*l1+l4*l4-s23*s23-(l2-l3)*(l2-l3);
	d=a*a+b*b-c*c;
	if (d>0) {
		th2=2.0*Math.atan2(-b+toggle*Math.sqrt(d),c-a);
		th4=Math.atan2((l2-l3)*Math.sin(th2)-s23*Math.cos(th2), (l2-l3)*Math.cos(th2)+s23*Math.sin(th2)-l1);
		th3=th2+Math.PI;
		th12=th2-th1;
		th23=th3-th12;
		th41=th1-th4;
